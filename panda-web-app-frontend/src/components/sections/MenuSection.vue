        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="form-actions">
            ...
            <button 
              ...
              class="submit-button"
            >
              {{ editingInventoryItem ? 'Update' : 'Add' }} Inventory Item
            </button>
          </div>
        </form>
      </div>
...
<div class="table-container">
      <table class="menu-item-table">
        ...
        <tbody>
          <tr v-for="menu_item in menu_items" :key="employee.menu_item">
